...
?>
  ...
  ?>
                        <div class="item active">
                            <img class="d-block img-fluid" src="owner/<?php echo $photo ?>" alt="First slide"
                                width="100%" style="max-height: 500px; min-height: 500px;">
                        </div>
                        <?php 
  }
  else
  ...
  ?>
            ...
            <div class="container-data">
                <h2 style="text-align: center; padding-right: 560px"><?php echo $rows['property_type'] ?></h2>
                <div style="display: flex; gap: 50px; padding-top: 10px">
                    ...
                    <ul class="container-li">
                        ...
                        <li>
                            ...
                            <p><?php echo $rows['contact_no']; ?></p>
                        </li>
                        <li>
                            <strong>Estimated Price</strong>
                            <p>Rp.<?php echo $rows['estimated_price']; ?></p>
                        </li>
                    </ul>
                    <ul>
                        <li>
                            <strong>Total Rooms</strong>
                            <p><?php echo $rows['total_rooms']; ?></p>
                        </li>
                        <li>
