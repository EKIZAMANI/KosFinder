...
<body>
    ...
    <div class="container-fluid">
        <ul class="nav nav-pills nav-justified">
            <li class="active" style="background-color: #FFF8DC"><a data-toggle="pill" href="#home">Property Lists</a>
            </li>
        ...
        if(mysqli_num_rows($result)>0)
      {
       ...
       ?>
            ...
            <div id="menu2" class="tab-pane fade">
                ...
                <div class="container">
                    <input type="text" id="myInput3" onkeyup="myFunction3()" placeholder="Search..."
                        title="Type in a name">
        ...
        if(mysqli_num_rows($result)>0)
      {
       ...
       ?>
            ...
            <div id="menu3" class="tab-pane fade">
                ...
                <div class="container">
                    <input type="text" id="myInput4" onkeyup="myFunction4()" placeholder="Search..."
                        title="Type in a name">
