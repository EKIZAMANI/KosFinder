...
$sql="SELECT * FROM add_property where concat(province,city,property_type) like '%$q_string%'";
    ...
    if(mysqli_num_rows($query2)>0)
    {
      $row=mysqli_fetch_assoc($query2); 
        ...
        echo  '<img class="image" src="owner/'.$photo.'">'; }?>
            ...
            <p><?php echo '<a href="view-property.php?property_id='.$rows['property_id'].'"  class="btn btn-lg btn-primary btn-block" >View Property </a><br>'; ?>
            </p><br>
        </div>
    </div>
